...
* Toolbar button to view or open CHAIN backlinks
* Workspace symbols include more instances

## [2.4.1] - 2026-03-29

### Fixes

* Fix a bug in the workspace rescan

## [2.4.0] - 2026-03-15

### Fixes

* Eliminate crash involving ONERR GOTO and REM
* Eliminate some unnecessary padding when moving lines

### New Features

* Workspace scan establishes CHAIN relationships
* Chained variables are accounted for in analysis
* Range-checker evaluates literal expressions

## [2.3.1] - 2026-01-11

### Fixes

* Symbols are regenerated when switching tabs
* Minfier can remove REM statements that end a file, even if they contain branch destinations
* Correct an issue where some syntax errors could go undetected
...
* Handles WOZ images that have been written to by MAME (flux tracks)
